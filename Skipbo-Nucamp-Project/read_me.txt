...
# stock_pile (goal of game = no cards)(unique to player): 
                                    ---> top card facing up; top card is the only card showing
                                    ---> can only play card showing; can't look at others
# hand: (unique to player) player sees all card in hand; only 5 to start turn
...
# mrComputer play priority: stock - hand - discard

# turn 1: first player draws 5 cards from draw_pile or refills hand to 5 cards
# play all 5 cards and you may draw 5 more
# play ends when player discards one card in discard pile
# cards left in hand are kept

# turn 2: second player draws 5 cards from draw_pile or refills hand to 5 cards
# play all 5 cards and you may draw 5 more
# play ends when player discards one card in discard pile
# cards left in hand are kept

# game continues until a player plays all of their stock pile
